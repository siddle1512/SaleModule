...
function SellerCrud(props) {
  ...
  async function loadSellers() {
    const result = await axios.get(import.meta.env.VITE_API_ENDPOINT + "/api/Seller/GetSeller");
  ...
  async function addSeller(event) {
    ...
    try {
      await axios.post(import.meta.env.VITE_API_ENDPOINT + "/api/Seller/AddSeller", {
        name: name,
        role: role,
        email: email,
        password: password,
  ...
  async function deleteSeller(id) {
    await axios.delete(import.meta.env.VITE_API_ENDPOINT + "/api/Seller/DeleteSeller/" + id);
  ...
  async function updateSeller(event) {
    ...
    try {
      await axios.patch(
        import.meta.env.VITE_API_ENDPOINT + `/api/Seller/UpdateSeller/${id}`,
        {
          id: id,
          name: name,
          role: role,
